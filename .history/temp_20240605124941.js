...
function checkprice()  {
    ...
    if (points >= Scost) {
        ...
        Msheetsbtn.disabled = true
    }
    if (points >= Pcost) {
        Mpillowsbtn.disabled = false
    }
    else {
        Mpillowbtn.disabled = true
    }
    if (points >= Bcost) {
        Mbedsbtn.disabled = false
    }
    else {
        bedsbtn.disabled = true
    }
    if (points >= Ncost) {
        Mnoisemachinebtn.disabled = false
    }
    else {
        Mnoisemachinebtn.disabled = true
    }
    if (points >= Acost) {
        Ma\csbtn.disabled = false
    }
    else {
        acsbtn.disabled = true
    }
}
