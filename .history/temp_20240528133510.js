...
let sheet = 0
let sheetTracker = document.getElementById("knife")
let bed = 0
let bedTracker = document.getElementById("bomb")
let noise = 0
let noiseTracker = document.getElementById("missile")
let ac = 0
let acTracker = document.getElementById("nuke")
let cps = 0
let cpsTracker = document.getElementById("cps")

function increasePoints() {
    points = points + 1 + (sheet * .2)
    tracker.innerText = points.toFixed(2) + " Time be fore "
}
